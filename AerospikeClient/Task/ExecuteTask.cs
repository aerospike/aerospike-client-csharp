...
namespace Aerospike.Client
{
	...
	public class ExecuteTask : BaseTask
	{
		...
		public override int QueryStatus()
		{
			...
			{
				string cmd1 = node.serverVersion >= Node.SERVER_VERSION_8_1 ?
					"query-show:id=" + taskId : "query-show:trid=" + taskId;
				string cmd2 = node.serverVersion >= Node.SERVER_VERSION_8_1 ?
					module + "-show:id=" + taskId : module + "-show:trid=" + taskId;
				string cmd3 = node.serverVersion >= Node.SERVER_VERSION_8_1 ?

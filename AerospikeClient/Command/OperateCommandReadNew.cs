...
{
	internal class OperateCommandReadNew : ReadCommandNew, ICommand
	{
		private readonly OperateArgs args;

		public OperateCommandReadNew(ArrayPool<byte> bufferPool, Cluster cluster, Key key, OperateArgs args)
			: base(bufferPool, cluster, args.writePolicy, key, true)
		{
			this.args = args;
		}

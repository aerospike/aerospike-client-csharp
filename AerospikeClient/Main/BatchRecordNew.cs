...
namespace Aerospike.Client
{
	...
	/// </summary>
	public class BatchRecordNew : KeyRecord
	{
		/// <summary>
		...
		/// </summary>
		public BatchRecordNew(Key key, bool hasWrite)
			: base(key, null)
		{
		...
		/// </summary>
		public BatchRecordNew(Key key, Record record, bool hasWrite)
			: base(key, record)
		{
		...
		/// Error constructor.
		/// </summary>
		public BatchRecordNew(Key key, Record record, int resultCode, bool inDoubt, bool hasWrite)
			: base(key, record)
		{

...
{
	public class AsyncBatchInit : TestAsync
	{
	...
	public class TestAsyncBatch : TestAsync, Xunit.IClassFixture<AsyncBatchInit>
	{
		public const string keyPrefix = "asyncbatchkey";
		public const string valuePrefix = "batchvalue";
		public static readonly string binName = args.GetBinName("batchbin");
		public const int size = 8;
		public static Key[] sendKeys;

		AsyncBatchInit fixture;

		public TestAsyncBatch(AsyncBatchInit fixture)
		{
